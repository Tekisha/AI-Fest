...
const SelectLabel = ({ className, ...props }) => <SelectPrimitive.Label className={"px-2 py-1.5 text-sm font-semibold"} {...props} />;
...
const SelectSeparator = ({ className, ...props }) => <SelectPrimitive.Separator className={"-mx-1 my-1 h-px bg-muted"} {...props} />;
